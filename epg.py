...
POSTER_URL = "https://raw.githubusercontent.com/ayoubboukous27/Starzplay-sports-epg-xml/refs/heads/main/Logos/seriea.jpg"
...
for day_offset in range(NUM_DAYS):
    ...
    for ch in CHANNELS:
        ...
        for match in day_matches:
            ...
            ET.SubElement(prog, "icon", src=POSTER_URL)  # Poster لكل البرنامج
            ET.SubElement(prog, "poster", src=POSTER_URL) # Poster إضافي متوافق مع بعض المشغلات
            ET.SubElement(prog, "banner", src=POSTER_URL) # Banner لجميع البرامج
        ...
        for hour in range(0, 24):
            if hour not in busy_hours:
                ...
                ET.SubElement(prog, "poster", src=POSTER_URL)
                ET.SubElement(prog, "banner", src=POSTER_URL)
...
print(f"تم إنشاء epg.xml لمدة {NUM_DAYS} يوم لكل القنوات الثلاثة مع Poster/Banner موحد لجميع البرامج")
