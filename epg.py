...
for day_offset in range(7):
    ...
    params = {
        "league": LEAGUE_ID,
        "season": 2026,  # السنة الحالية أو الموسم الحالي
        "date": date_str
    }
    ...
    if not events:
        # لا توجد مباريات → برنامج وهمي 2 ساعة
        ...
        for match in events:
            ...
            stop_dt = start_dt + timedelta(hours=2)  # نفترض 2 ساعة لكل مباراة
...
print("تم إنشاء epg.xml يغطي 7 أيام من مباريات Serie A")
